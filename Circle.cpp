...
Circle::Circle(Point *V1, Point *V2, Point *V3)
{
    ...
    pt1->x = V1->x;         pt2->x = V2->x;         pt3->x = V3->x;
    pt1->y = V1->y;         pt2->y = V2->y;         pt3->y = V3->y;
...
double Circle::length(Point Centre, Point *pt1)
{
    int deltaX = Centre.x - pt1->x;
    int deltaY = Centre.y - pt1->y;
    
    double radius = pow (deltaX,2);
